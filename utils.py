...
def gen_prv(queue, proxy_set=None):
    ...
    providers.append(prv.BlockedProvider(queue, proxy_set, url='http://www.sslproxies.org/'))
    ...
    providers.append(prv.BlockedProvider(queue, proxy_set, url='http://fineproxy.org/eng/'))
    ...
    providers.append(prv.BlockedProvider(queue, proxy_set, url='http://codediaries.com/list.php'))
    ...
    providers.append(prv.BlockedProvider(queue, proxy_set, url='http://www.ip-adress.com/proxy_list/?k=time'))
    providers.append(prv.BlockedProvider(queue, proxy_set, url='http://myproxylists.com/free-proxy-list'))
    providers.append(prv.BlockedProvider(queue, proxy_set, url='http://cn-proxy.com/'))
